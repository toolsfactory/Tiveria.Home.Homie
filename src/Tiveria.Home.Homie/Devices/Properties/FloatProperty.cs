...
namespace Tiveria.Home.Homie.Devices.Properties
{
    public class FloatProperty : BaseProperty
    {
        public FloatProperty(Node node, string id, string name = "default", string format = "", string unit = "", bool settable = false, bool retained = true)
            : base(node, id, DataTypes.Float, name, format, unit, settable, retained) { }
